...
# Create a small dataframe with two students
df <- data.frame(student_name = c("Henrik", "Nina"),
                 department_code = c(2, 3))
# Insert two students using psql_append_df
...
timestamp <- lubridate::ymd_hms(names(dat$`Time Series (60min)`), tz = "America/New_York")
